...
console.log('\nthe fight, twelve spawn rotations per claim');
{
  ...
  check('flying into the middle of the first claim usually kills you',
    table[0].inDied >= ROT * 0.6 && table[0].inCleared < table[0].cleared,
    `${table[0].inDied} of ${ROT} dead and ${table[0].inCleared} of ${ROT} cleared, against `
    + `${table[0].cleared} of ${ROT} for a pilot who stays out of the rings — five fields and `
    + 'no lane through them is the whole of what the first claim asks');
